...
def parse_opts():
    ...
    parser.add_argument('--manual_seed', default=114514, type=int, help='Manually set random seed')
    parser.add_argument('--no_cuda', action='store_true', help='If true, cuda is not used.')
    parser.add_argument('--batch_size', default=64, type=int, help='Batch Size')
    parser.add_argument('--inference_batch_size', default=15, type=int, help='Batch Size for inference. 0 means this is the same as batch_size.')
    ...
    parser.add_argument('--test_epoch', default='.pth', type=str, help='path of test_checkpoints')
    ...
    parser.add_argument('--root_path', default='/root/eye_emotion', type=Path, help='Root directory path')
    parser.add_argument('--event_video_path', default='SEE2/event', type=Path, help='path of events')
    parser.add_argument('--frame_video_path', default='SEE2/frame', type=Path, help='path of frame')
    parser.add_argument('--annotation_path', default='SEE2/emotion.json', type=Path, help='path of .json (division of training and testing dataset)')
    ...
    parser.add_argument('--sample_size', default=100, type=int, help='Height and width of inputs')
